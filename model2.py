...
class VariationalAutoEncoder2(nn.Module):
    ...
    def _initialize_weights(self):
        ...
        # Zero-initialize pole output biases so poles start near the origin (matches Ben)
    ...
    def sample(self, mu, logvar):
        logvar = torch.clamp(logvar, min=-50, max=50)  # Numerical stability (matches Ben's VAE2)
    ...
    def decode_poles_residues(self, z):
        ...
        a = a / (a_sum + 1e-12)  # Normalize real part of the residues (1e-12 prevents div-by-zero, matches Ben)
