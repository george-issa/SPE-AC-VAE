...
Drop-in replacement for model2.py with two targeted changes:
  ...
  2. All activations replaced by SiLU
...
class VariationalAutoEncoder2(nn.Module):
    ...
    def encode(self, x):
        ...
        # Conv stack: InstanceNorm1d normalises each sample, SiLU bounds activations
        h = F.silu(self.norm1(self.conv1(x.unsqueeze(1))))
